Feature: Fundaraising
  ...
  Scenario: Request for program submission
    ...
    When I log in as an admin with access rights to manage program submissions
  ...
  Scenario: List of Programs
    Given I am on the web browser page
    When I log in as an admin with access rights to manage programs
  ...
  Scenario: Transactions of users participating in this program
    Given I am on the web browser page
    When I log in as an admin with access rights to manage the program
